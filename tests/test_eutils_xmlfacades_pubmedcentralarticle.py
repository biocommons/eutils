...
def test_eutils_xmlfacades_pubmedcentralarticle_PMC3299399(client):  # noqa: N802
    ...
    assert (
        "It is characterized by hallucinations and delusions, reduced emotion and cognitive impairment"
        in pa.body_text
    )
    assert (
        "PubmedCentralArticle(pmc=3299399;pmid=22416237;doi=10.3389/fpsyt.2012.00018;The Effects of Psychosis Risk Variants on Brain Connectivity: A Review)"
        in str(pa)
    )
