...
project = u'eutils'
copyright = u'2015, eutils Committers'
...
latex_documents = [
  ('index', 'eutils.tex', u'eutils Documentation',
   u'Reece Hart', 'manual'),
]
...
man_pages = [
    ('index', 'eutils', u'eutils Documentation',
     [u'Reece Hart'], 1)
]
...
texinfo_documents = [
  ('index', 'eutils', u'eutils Documentation',
   u'Reece Hart', 'eutils', 'One line description of project.',
   'Miscellaneous'),
]
